...
const experience = {
  en: [
    ["Since 04/2026", "Career Coaching – High Profiling®", "INQUA-Institute · Berlin, Germany", ["Professional career development and positioning for the German job market."]],
    ["07/2016—03/2023", "Mobile RAN Engineer – Network Operations and Optimization", "FPR Co. / Delta Ertebatat Iranian · Huawei RAN projects · Tehran, Iran", ["Managed the operation, configuration, optimization, and troubleshooting of a nationwide Huawei RAN with 13,000+ network elements across 2G, 3G, 4G, and early 5G.", "Performed 50+ live software upgrades and validated 400+ configuration changes, including technical risk assessment and service-continuity safeguards.", "Conducted KPI- and protocol-based root-cause analysis across RRC, NAS, MAC, and PHY using RSRP, SINR, BLER, throughput, latency, and handover performance.", "Acted as the technical interface between customer teams, internal engineering units, and Huawei R&D during incidents, escalations, and feature deployments."]],
    ["05/2015—07/2016", "RAN Modernization and Integration Engineer", "Iran Ofogh Industrial Development Co. · Assigned to ZTE Parsian · Tehran, Iran", ["Integrated 900+ BTS sites and additional network nodes during a large-scale modernization rollout while maintaining compatibility and stable operation.", "Coordinated site integration, radio configuration, and parameter implementation with field-service and planning teams during expansion and LTE migration.", "Validated post-change performance through alarms and KPIs, then analyzed and resolved integration and configuration issues in live networks."]],
    ["03/2013—03/2015", "RAN Operations Engineer", "SGS Iran · Huawei Technologies service project · Tehran, Iran", ["Continuously monitored network status, availability, alarms, and traffic trends in a shift-based live RAN environment.", "Analyzed accessibility, retainability, mobility, and capacity KPIs and performed structured first-level troubleshooting.", "Documented and escalated incidents with coordinated handover to specialist teams under defined procedures and SLAs.", "Prepared and quality-assured daily and weekly KPI reports while supporting consistent operational reporting."]],
  ],
  de: [
    ["Seit 04/2026", "Karriere-Coaching High Profiling®", "INQUA-Institut · Berlin, Deutschland", ["Berufliche Entwicklung und Positionierung auf dem deutschen Arbeitsmarkt."]],
    ["07/2016—03/2023", "Mobilfunk-RAN-Ingenieur – Netzbetrieb und -optimierung", "FPR Co. / Delta Ertebatat Iranian · Huawei RAN-Projekte · Teheran, Iran", ["Verantwortung für Betrieb, Konfiguration, Optimierung und Fehlerbehebung eines landesweiten Huawei RAN mit über 13.000 Netzelementen für 2G, 3G, 4G und erste 5G-Dienste.", "Durchführung von mehr als 50 Live-Software-Upgrades und Validierung von über 400 Konfigurationsänderungen inklusive Risikobewertung und Sicherung der Servicekontinuität.", "KPI- und protokollbasierte Ursachenanalyse auf RRC-, NAS-, MAC- und PHY-Ebene anhand von RSRP, SINR, BLER, Durchsatz, Latenz und Handover-Performance.", "Technische Schnittstelle zwischen Kundenteams, internen Engineering-Einheiten und Huawei R&D bei Störungen, Eskalationen und Feature-Einführungen."]],
    ["05/2015—07/2016", "RAN Modernization and Integration Engineer", "Iran Ofogh Industrial Development Co. · Eingesetzt bei ZTE Parsian · Teheran, Iran", ["Integration von über 900 BTS und weiteren Netzknoten in einem groß angelegten Modernisierungs-Rollout bei stabilem Netzbetrieb.", "Koordination von Standortintegration, Funkkonfiguration und Parametrierung mit Field-Service- und Planungsteams bei Netzerweiterungen und LTE-Migration.", "Validierung der Netzperformance anhand von Alarmen und KPIs sowie Analyse und Behebung von Integrations- und Konfigurationsfehlern in Live-Netzen."]],
    ["03/2013—03/2015", "RAN Operations Engineer", "SGS Iran · Huawei Technologies Serviceprojekt · Teheran, Iran", ["Kontinuierliche Überwachung von Netzstatus, Verfügbarkeit, Alarmen und Verkehrsentwicklung im Schichtbetrieb eines produktiven RAN.", "Analyse von Accessibility-, Retainability-, Mobility- und Kapazitäts-KPIs sowie strukturierte Erstdiagnose und First-Level-Troubleshooting.", "Dokumentation und Eskalation von Incidents mit koordinierter Übergabe an Spezialistenteams gemäß Betriebsprozessen und SLAs.", "Erstellung und Qualitätssicherung täglicher und wöchentlicher KPI-Berichte sowie Unterstützung einer konsistenten Betriebsberichterstattung."]],
  ],
};
